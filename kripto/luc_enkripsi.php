<?php include "../fungsi/fungsi_luc.php";
...
<div id="Enkripsi" class="tabcontent">
    ...
    <form method="post" action="luc_enkripsi.php">
...
<div id="Dekripsi" class="tabcontent">
    ...
    <form method="post" action="luc_dekripsi.php">
...
<div id="Prima" class="tabcontent">
    ...
    <form method="post" action="luc_cek_bilangan_prima.php">
